...
Icon = pygame.image.load("arkanoid_pexel.png")
...
colors = [(randrange(30, 256), randrange(30, 256), randrange(30, 256)) for i in range(10) for j in range(8)]
...
while True:
    ...
    #Vertical collision
    if ball.centery < ball_radius or ball.centery > HEIGHT:
        vel_y = -vel_y
        pygame.mixer.Sound.play(bounce_sound)
